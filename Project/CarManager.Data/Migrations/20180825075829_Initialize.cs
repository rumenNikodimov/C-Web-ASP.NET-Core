        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrnetKilometers = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentKilometers = table.Column<double>(nullable: false),
                    ExpireKilometers = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceDatas_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpireDate = table.Column<DateTime>(nullable: false),
                    VeihleId = table.Column<int>(nullable: false),
                    VehicleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleTaxes_TaxNames_NameId",
                        column: x => x.NameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDatas_VehicleId",
                table: "ServiceDatas",
                column: "VehicleId");
